...
CMD $REGISTRY_HOME/bin/zookeeper-server-start $REGISTRY_HOME/etc/kafka/zookeeper.properties & \
$REGISTRY_HOME/bin/kafka-server-start $REGISTRY_HOME/etc/kafka/server.properties & \
